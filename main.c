...
void output_stats(struct stat_struct *result, struct mem_config *mem, struct cache *l1_i, struct cache *l1_d, struct cache *l2)
{
	...
	printf("    Dcache Size = %d : ways = %d : block size = %d\n", l1_d.cache_size, l1_d.assoc,l1_d.block_size);
	printf("    Icache Size = %d : ways = %d : block size = %d\n", l1_i.cache_size, l1_i.assoc,l1_i.block_size);
	...
	printf("    Kickouts = %lld; Dirty Kickouts = %lld; Transfers = %lld\n",l1_i.cache_stats.kickouts,l1_i.cache_stats.dirty_kickouts,<tranfers>);
	...
	printf("    Kickouts = %lld; Dirty Kickouts = %lld; Transfers = %lld\n",l1_d.cache_stats.kickouts,l1_d.cache_stats.dirty_kickouts,<tranfers>);
	...
	printf("    Kickouts = %lld; Dirty Kickouts = %lld; Transfers = %lld\n",l2.cache_stats.kickouts,l2.cache_stats.dirty_kickouts,<tranfers>);
